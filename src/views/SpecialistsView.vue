...
>
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <h2 class="heading-font text-4xl font-bold mb-12">
      {{ section.title }}
    </h2>
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div
        v-for="specialist in section.specialists"
        :key="specialist.key"
        class="border border-[#D4AF37] rounded-3xl p-6 shadow-lg hover:-translate-y-2 transition"
      >

        <img
          :src="specialist.img"
          :alt="specialist.name"
          class="h-56 w-full object-cover rounded-2xl mb-4"
        />
        ...
        <p class="text-gray-600 text-sm mt-3">
          ⭐ {{ specialist.rating }} | {{ specialist.exp }} Experience
        </p>

        <RouterLink
          :to="`/book?specialist=${specialist.key}&service=${specialist.service}`"
          class="mt-5 inline-block bg-[#D4AF37] text-white px-6 py-2 rounded-full text-sm hover:bg-[#c39d28] transition"
        >
